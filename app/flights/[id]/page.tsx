...
import { getFlightById, getActiveFlights, getPopularFlights } from '@/app/data/flights';
...
// Reviews are now loaded dynamically from @/app/data/testimonials.ts
// This enables backend integration and proper data management
